...
public class CadastroMB {
    ...
    public void salvar() throws SQLException {
        ...
        if (this.cadastro.getSenha() == null ? this.cadastro.getConf_senha() == null : this.cadastro.getSenha().equals(this.cadastro.getConf_senha())) {
    ...
    public void pesquisar() throws SQLException {
        cadastro = cadastroDAO.pesquisar(cadastro.getId());
    }
