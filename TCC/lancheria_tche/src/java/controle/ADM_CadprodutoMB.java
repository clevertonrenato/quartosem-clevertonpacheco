...
import persistencia.ADM_Cadastro_produtoDAO;
import persistencia.Cadastro_produtoDAO;

@ManagedBean
@RequestScoped
public class ADM_CadprodutoMB {

    private Cadastro_produto conta;
    private ADM_Cadastro_produtoDAO contaDAO;
    private List<Cadastro_produto> contas;
    private String filtroDescricao;
    private String filtroTipo;

    public ADM_CadprodutoMB() throws SQLException {
        this.conta = new Cadastro_produto();
        this.contaDAO = new ADM_Cadastro_produtoDAO();
        this.listar();
    }
