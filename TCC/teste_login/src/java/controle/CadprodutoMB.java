...
public class CadprodutoMB {
   ...
   //O mp3 é um objeto da classe Mp3 e é utilizado para apresentar dados
    ...
    private Cadastro_produto cadprod;
    ...
    //excluir() e pesquisar().
    private Cadastro_produtoDAO cadprodDAO;
    ...
    private List<Cadastro_produto> cadprods;
   ...
   // private List<Convert_lanche> convert_lanches;
    ...
    public CadprodutoMB() throws SQLException {
        ...
        cadprodDAO = new Cadastro_produtoDAO();
        cadprods = cadprodDAO.getTodosCadastro_lanche(Cadastro_produtoDAO.ORDEM_POR_ID); //Monta a lista de músicas.
    ...
    public List<Cadastro_produto> getCadprods() {
        return cadprods;
    }
   ...
   // }  
    ...
    public Cadastro_produto getCadastro_lanche() {
        return cadprod ;
    }

    public void setCadastro_lanche(Cadastro_produto cadprod) {
    ...
    public String salvar() throws SQLException {
        ...
        if (this.cadprod.getId() == 0) {
         ...
         cadprods = cadprodDAO.getTodosCadastro_lanche(Cadastro_produtoDAO.ORDEM_POR_ID);
         this.novo();
         return "cadastro_lanche?faces-redirect=true";
    }
    //Este é o método que será chamado quando o usuário clicar no link
    //editar de uma linha do <h:dataTable>
    public void editar(Cadastro_produto dados) {
        this.cadprod = dados;
    }
